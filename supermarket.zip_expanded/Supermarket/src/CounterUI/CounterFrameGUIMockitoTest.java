...
public class CounterFrameGUIMockitoTest {
	...
	@Test
	public void testSubmitButton_actionPerformed() throws Exception {
		instance.show();
		setBuy(0, 0);
		instance.SubmitButton_actionPerformed(null);
		verify(mockProxy).buy(1,1); // verify method call
	}
